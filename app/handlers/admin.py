...
async def admin_post_handler(
    ...
    if user_role not in ["admin", "owner"]:
        return # Should be caught by middleware, but as a safeguard.
    
    if not message.reply_to_message:
        await message.answer("Please reply to a message to post it directly.")
        return

    # In a real scenario, you'd likely want a subject for direct posts too.
    # For this implementation, we'll use a default.
